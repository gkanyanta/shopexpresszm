...
const slides = [
  {
    ...
    description:
      "Discover designer handbags, premium fragrances, sunglasses, and more. Shop authentic luxury brands delivered straight to your door across Zambia.",
    cta: { label: "Shop Fashion", href: "/shop" },
  ...
  },
  {
    ...
    description:
      "From classic leather to modern designs — find the perfect bag for every occasion. Authentic brands, unbeatable prices, nationwide delivery.",
  ...
  },
  {
    ...
    title: "Designer",
    highlight: "Timepieces.",
    subtitle: "Make Every Second Count.",
    description:
      "Explore our collection of luxury watches from top international brands. Can't find what you want? Use our Buy For Me service to source it from abroad.",
  ...
  },
  {
    ...
    title: "Hottest",
    highlight: "Sneakers.",
    subtitle: "Fresh Kicks, Fast Delivery.",
    description:
      "Get the latest drops from Jordan, Nike, Adidas, and more. Sourced locally and internationally — delivered to all 10 provinces in Zambia.",
    cta: { label: "Shop Sneakers", href: "/shop" },
    ctaSecondary: { label: "Buy From Abroad", href: "/buy-for-me" },
  },
  {
    ...
    description:
      "From the streets of New York to the heart of Lusaka. Shop trending footwear and fashion with fast, reliable delivery powered by Inland Express Zambia.",
    cta: { label: "Shop Now", href: "/shop" },
